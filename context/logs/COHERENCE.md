...
intent: Markdown‑first provenance of changes to context, content, procedures, and workflows
status: active
updated: 2025-10-08
...
- Append an entry after every procedure/workflow and any edit/add to `context/` or `content/`.
...
Policy
- After completing any procedure/workflow or making changes to context/content, append a log entry using `procedures/core/update_log.md:1`.
